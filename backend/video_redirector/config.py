...
PROXY_CONFIG = {
    ...
    "max_rate_limit_events": int(os.getenv("PROXY_MAX_RATE_LIMIT_EVENTS", "10")), # if "wait to upload big file for 7 seconds" happened in last 10 minutes 3 times - reload proxy IP
}