...
class TMDBService:
    ...
    async def search_movie(self, query: str, language: str = "en-US", page: int = 1):
    ...
    async def discover_movies(self, genres: list[int], years: list[int], language: str = "en-US", page: int = 1):
